...
namespace MVCEFCodeFirstOnlineMartScenario.Controllers
{
    public class SecurityQuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "QuId,Question")] SecurityQuestion securityQuestion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "QuId,Question")] SecurityQuestion securityQuestion)
        {
            if (ModelState.IsValid)
            {
